...
const jsonURL = "https://cdn.jsdelivr.net/gh/ussthq-web-coordinator/USSTHQ-1@latest/DashboardData-m.json";
...
async function fetchData() {
  try {
    ...
    document.getElementById("refreshDate").textContent = refreshUTC ? "Version 1.921414 - Last refreshed (Eastern): " + refreshUTC.toLocaleString("en-US",{ timeZone:"America/New_York", dateStyle:"medium", timeStyle:"short"}) : "Last refreshed: Unknown";
